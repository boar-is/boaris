...
It’s frustrating, it’s not part of business logic, and it’s definitely *not* fun.
...
And even though this is an “enough-is-enough” setup,
...
### Basic Fields
Next.js docs introduce you to “[Basic Fields](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#basic-fields)”.
But do you *really* need them? And what about “Advanced Fields”?

The truth is, search engines [don’t care about most of them](https://developers.google.com/search/docs/crawling-indexing/special-tags).
...
Now that we’ve removed duplication, [templates](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#template-object) are useful again!
...
![Next.js Docs](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/zeli0yk1z453vk2j81de.png)
...
![Next.js Docs](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/98xkgrecf0ytdczr18am.png)
...
![Next.js Docs](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xkkdp9l6ydrnvu8eis6c.png)
...
![OpenGraph Images](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/8canu5uukb2hvkqouz3m.png)
...
First, [Font Optimization](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) **doesn’t work** with `ImageResponse`.
...
![Inter Font Features](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/9jiyx2ca6nd4ci80w4un.png)
...
![Too much icons](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wgylc7u6mj4hd686wbny.png)
...
![App icons](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/k12vlco6xel7q6r81n23.png)
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/8bzmis56tuhgmwf9i77p.png)
...
It’s also useful for things like resolving the `basePath` for [Auth.js](https://authjs.dev/) endpoints.
Thank me later!
