...
export default async function SitePage() {
  ...
  return (
    <div className="~space-y-12/20">
      <article className="container text-center ~py-12/24">
        <p className="text-accent-11 font-semibold tracking-wide ~text-lg/2xl">
          Hi! I'm Boaris
        </p>
        <h1 className="~text-4xl/7xl font-extrabold tracking-tight text-balance bg-gradient-to-b from-gray-12 to-gray-11 bg-clip-text text-transparent mt-3 mb-8 ~pb-1/1.5">
          I’m on a mission to make learning more{whitespace}
          <em className="underline decoration-accent-11 decoration-wavy ">
            effective
          </em>
        </h1>
        <p className="text-gray-12/75 ~text-xl/2xl font-medium text-balance !leading-relaxed max-w-prose mx-auto">
