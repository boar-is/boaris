    ...
    assets: [
      ...
      new AssetText({
        ...
        advances: [
          ...
          ...ch1(1788, 1788, [[1750, [[544], [[[81, 87]], null]]]]),
          ...ch1(1819, 1819, [[3069, [[544], [[[114, 118]], null]]]]),
          ...ch1(1850, 1888, [
            [
              200,
              [
                [
                  36,
                  [0, '', "import { notFound } from 'next/navigation'"],
                  508,
                ],
                [[[79, 36]], null],
              ],
          ...
          ...ch1(1889, 1936, [
            ...
            [
              1413,
              [
                [174, [0, '  const posts = await fetchRecentPosts()'], 779],
                [[[214, null]], null],
              ],
            ],
            [
            ...
            [
              1937,
              [
                [215, [0, '  return posts.map(({ slug }) => ({ slug }))'], 779],
                [[[259, null]], null],
              ],
            ],
          ]),
