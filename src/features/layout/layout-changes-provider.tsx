...
import { useLayoutModeContext } from '~/features/layout/layout-mode-provider'
...
export const [LayoutChangesContext, useLayoutChangesContext] =
...
export function LayoutChangesProvider({
  ...
  const { currentLayoutMode$, primaryLayoutModes } = useLayoutModeContext()
